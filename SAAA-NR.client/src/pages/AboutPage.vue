    ...
    <section class="row ">
      ...
      <div class="col-12 table-card align-items-center my-2 border-upgrade">
        <div class="row align-items-center">
          ...
          <div class="col-md-1 col-12 text-md-center text-end">
            <!-- <a class="mdi mdi-github fs-1" href="https://github.com/axelarciniega"></a>
      ...
      <div class="col-12 table-card align-items-center my-2 border-upgrade">
        <div class="row align-items-center">
          ...
          <div class="col-md-1 col-12 text-md-center text-end">
            <!-- <a class="mdi mdi-github fs-1" href="https://github.com/bluebear2015"></a>
      ...
      <div class="col-12 table-card align-items-center my-2 border-upgrade">
        <div class="row align-items-center">
          ...
          <div class="col-md-1 col-12 text-md-center text-end">
            <!-- <a class="mdi mdi-github fs-1" href="https://github.com/YouFoundTiffany"></a>
      ...
      <div class="col-12 table-card align-items-center my-2 mb-3 border-upgrade">
        <div class="row align-items-center">
          ...
          <div class="col-md-1 col-12 text-md-center text-end">
            <!-- <a class="mdi mdi-github fs-1" href="https://github.com/CamilleIvins"></a>
            <a class="mdi mdi-linkedin fs-1" href="https://www.linkedin.com/in/camille-ivins-1a7969113"></a> -->
          </div>
        </div>
      </div>
...
.border-upgrade {
  border: solid 4px var(--vista-blue);
}
